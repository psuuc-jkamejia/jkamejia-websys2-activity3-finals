...
<div class="container mx-auto p-6">
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="flex space-x-4">
            <!-- Edit Button -->
            <button> 
                <a href="<?php echo e(route('students.edit', $student->id)); ?>" class="bg-blue-500 text-black font-bold py-2 px-4 rounded-lg">
                    Edit
                </a>
            </button> <br>
            ...
            <button>
                <a href="data:image/png;base64, <?php echo base64_encode(QrCode::size(200)->generate($qrData)); ?>" download="student_qr_code.png" class="bg-blue-500 text-black font-bold py-2 px-4 rounded-lg">
                    Download QR Code
                </a>
            </button>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KENN Folder\QR Activity 3\resources\views/students/show.blade.php ENDPATH**/ ?>